        ...
        <div class="exam-boxes">
          ...
          <div class="group code d-flex">
            ...
            <div class="btnItem">
              <button class="primary">
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12.25 12.25L8.75 8.75M9.91667 5.83333C9.91667 8.0885 8.0885 9.91667 5.83333 9.91667C3.57817 9.91667 1.75 8.0885 1.75 5.83333C1.75 3.57817 3.57817 1.75 5.83333 1.75C8.0885 1.75 9.91667 3.57817 9.91667 5.83333Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                </button>
            </div>
            <div class="btnItem">
            ...
            <div class="btnItem">
              <button class="quaternary">
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12.25 12.25L8.75 8.75M9.91667 5.83333C9.91667 8.0885 8.0885 9.91667 5.83333 9.91667C3.57817 9.91667 1.75 8.0885 1.75 5.83333C1.75 3.57817 3.57817 1.75 5.83333 1.75C8.0885 1.75 9.91667 3.57817 9.91667 5.83333Z" stroke="#87878E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </button>
            </div>
            <div class="btnItem">
          ...
          <div class="group code d-flex">
            ...
            <div class="btnItem">
              <button class="quaternary small">
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M10.5 10.5L7.5 7.5M8.5 5C8.5 6.933 6.933 8.5 5 8.5C3.067 8.5 1.5 6.933 1.5 5C1.5 3.067 3.067 1.5 5 1.5C6.933 1.5 8.5 3.067 8.5 5Z" stroke="#87878E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg> 
              </button>
            </div>
            <div class="btnItem">
              <button class="primary small" disabled>
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M10.5 10.5L7.5 7.5M8.5 5C8.5 6.933 6.933 8.5 5 8.5C3.067 8.5 1.5 6.933 1.5 5C1.5 3.067 3.067 1.5 5 1.5C6.933 1.5 8.5 3.067 8.5 5Z" stroke="#C1C1CC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg> 
              </button>
            </div>
            <div class="btnItem ms-auto">
        ...
        <div class="exam-boxes">
          ...
          <div class="item">
            <div class="inner gap">
              ...
              <div class="bg-stripes margin p-16"><p class="uiFnt size-12 wgt-400 mono-700 px-64 py-16 bgMono-300 borderAll-mono">m-16</p></div>
            </div>
            <div class="inner">
      ...
      <div id="padding">
        ...
        <div class="exam-boxes">
          ...
          <div class="item">
            <div class="inner gap">
              <div class="fix-width-100"><div class="uiFnt size-11 wgt-500 smallTag">all sides</div></div>
              <div class="bg-stripes padding p-16 borderAll-mono"><p class="uiFnt size-12 wgt-400 mono-700 px-64 py-16 bgMono-300">p-16</p></div>
            </div>
            <div class="inner">
